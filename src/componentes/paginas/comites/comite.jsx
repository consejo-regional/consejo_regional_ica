    ...
    var contenido = {
      ...
      return(
        ...
        <div className="container-descripccion-colegio">
            ...
            <p className="contenido_cart_descripccion">Art. 72.º del Reglamento del CMP. DEL COMITÉ DE VIGILANCIA ÉTICA Y DEONTOLÓGICA</p> 
            <p className="contenido_cart_descripccion">Corresponde al Comité de Vigilancia Ética y Deontológica:</p> 
            <p className="contenido_cart_descripccion">72.1. Difundir y vigilar el cumplimiento de las disposiciones de la Ley, Estatuto, Reglamento, Código de Ética y Deontología, su reglamento y cualquier norma o acuerdo emanado del Consejo Nacional o Consejos Regionales en su caso.</p> 
            <p className="contenido_cart_descripccion">72.2. Solicitar previo acuerdo al Consejo Regional, abrir procedimiento ético disciplinario a cualquier miembro de la orden por la violación o incumplimiento del Estatuto, Reglamentos, Código de Ética y Deontología, o cualquier norma o acuerdo emanado del Consejo Nacional o Consejo Regional en su caso</p> 
            <p className="contenido_cart_descripccion">72.3. Denunciar, previo acuerdo, ante el Consejo Nacional a cualquiera de los miembros de dicho organismo colegiado por la violación o incumplimiento del Estatuto, Reglamentos, Código de Ética y Deontología o cualquier norma o acuerdo emanado del Consejo Nacional o Consejo Regional en su caso.</p> 
            <p className="contenido_cart_descripccion">72.4. Solicitar previo acuerdo, ante el Consejo Nacional, abrir procedimiento ético disciplinario a los miembros de los Consejos Regionales que corporativamente hayan violado o incumplido del Estatuto, Reglamentos, Código de Ética y Deontología o cualquier norma o acuerdo emanado del Consejo Nacional o Consejo Regional en su caso.</p> 
            <p className="contenido_cart_descripccion">72.5. Defender el prestigio profesional, cuando la profesión o los médicos, individual o colectivamente, sean objeto de agravio</p> 
            <p className="contenido_cart_descripccion">72.6. Denunciar ante el Consejo Nacional cuando en las actividades de las instituciones médicas, científicas, asistenciales u otras relacionadas con la medicina, se incurra en transgresiones a las normas éticas y deontológicas.</p> 
            <p className="contenido_cart_descripccion">72.7. Vigilar, en coordinación con los Consejos Regionales que el aviso profesional no se aparte de las normas que el Colegio establezca al respecto</p> 
            <p className="contenido_cart_descripccion">72.8. Absolver las consultas sobre asuntos de ética y deontología profesional que en vía de apelación, sean puestas en su conocimiento por el Consejo Nacional o los Consejos Regionales soliciten en su caso, vía su propio Comité de Vigilancia Ética y Deontológica.</p> 
            <p className="contenido_cart_descripccion">72.9. Coordinar con los Consejos Regionales la difusión y conocimiento del Código de Ética, así como de los principios bioéticos y deontológicos.</p> 
            <p className="contenido_cart_descripccion">72.10. Cumplir con los encargos del Comité Ejecutivo y del Consejo Nacional.</p> 
