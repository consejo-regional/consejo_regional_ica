        ...
        <div className="contenedor_footer">
            ...
            <div className="item_contenedor_footer">
                ...
                <div className="item_contenedor_footer_bloque">
                    <h1 className="item_contenedor_texto_titulo">DECANO</h1>
            ...
            <div className="item_contenedor_footer">
                ...
                <div className="item_contenedor_footer_bloque">
                    <h1 className="item_contenedor_texto_titulo">SECRETARIA</h1>
                ...
                <div className="item_contenedor_footer_bloque">
                    <h1 className="item_contenedor_texto_titulo">ADMINISTRACION</h1>
            ...
            <div className="item_contenedor_footer">
                ...
                <div className="item_contenedor_footer_bloque">
                    ...
                    <h1 className="item_contenedor_texto_titulo">SISTEMAS</h1>
            ...
            <div className="item_contenedor_footer">
                ...
                <div className="item_contenedor_footer_bloque">
                    ...
                    <h1 className="item_contenedor_texto_titulo">COBRANZAS</h1>
                ...
                <div className="item_contenedor_footer_bloque">
                    <h1 className="item_contenedor_texto_titulo">CONTABILIDAD</h1>
